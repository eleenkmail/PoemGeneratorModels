...
![Arabic Model Evaluation](images/Arabic model evaluation.png)

![English Model Evaluation](images/English model evaluation.png)
...
### Arabic Model:
!(images/Arabic model results.png)
- **Seed Text:** الحزن
...
### English Model:
!(images/English model results.png)
- **Seed Text:** happy
